...
LABEL distro_style="yum" distro="centos" distro_long="centos-7" arch="x86_64" ocaml_version="4.04.1" opam_version="master" operatingsystem="linux"
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp ocaml-base-compiler.4.04.1 /home/opam/opam-repository" && \
