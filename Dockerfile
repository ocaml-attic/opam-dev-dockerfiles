...
LABEL distro_style="apt" distro="ubuntu" distro_long="ubuntu-16.10" arch="x86_64" ocaml_version="4.06.0" opam_version="master" operatingsystem="linux"
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp ocaml-variants.4.06.0 /home/opam/opam-repository" && \
