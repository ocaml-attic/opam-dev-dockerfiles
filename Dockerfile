...
LABEL distro_style="yum" distro="oraclelinux" distro_long="oraclelinux-7" arch="x86_64" ocaml_version="4.00.1" opam_version="master" operatingsystem="linux"
RUN rpm --rebuilddb && yum install -y sudo passwd bzip2 patch nano git which tar wget xz openssl && yum clean all && \
