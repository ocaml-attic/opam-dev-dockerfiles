...
LABEL distro_style="apk" distro="alpine-armhf" distro_long="alpine-armhf-3.4" arch="armv7" ocaml_version="4.04.0+flambda" opam_version="master" operatingsystem="linux"
