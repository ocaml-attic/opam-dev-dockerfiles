...
LABEL distro_style="apk" distro="alpine-armhf" distro_long="alpine-armhf-3.4" arch="armv7" ocaml_version="4.05.0" opam_version="master" operatingsystem="linux"
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp ocaml-variants.4.05.0+trunk /home/opam/opam-repository" && \
