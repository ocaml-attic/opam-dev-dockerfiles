...
LABEL distro_style="apt" distro="raspbian" distro_long="raspbian-8" arch="armv7" ocaml_version="4.04.0+flambda" opam_version="master" operatingsystem="linux"
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp ocaml-variants.4.04.0+trunk+flambda /home/opam/opam-repository" && \
