...
LABEL distro_style="yum" distro="oraclelinux" distro_long="oraclelinux-7" arch="x86_64" ocaml_version="4.04.1+flambda" opam_version="master" operatingsystem="linux"
