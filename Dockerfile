...
LABEL distro_style="yum" distro="fedora" distro_long="fedora-22" arch="x86_64" ocaml_version="4.04.2+flambda" opam_version="master" operatingsystem="linux"
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp ocaml-variants.4.04.2+flambda /home/opam/opam-repository" && \
