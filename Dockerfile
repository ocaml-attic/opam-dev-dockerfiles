...
LABEL distro_style="yum" distro="fedora" distro_long="fedora-25" arch="x86_64" ocaml_version="4.06.0+flambda" opam_version="master" operatingsystem="linux"
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp ocaml-variants.4.06.0+flambda /home/opam/opam-repository" && \
