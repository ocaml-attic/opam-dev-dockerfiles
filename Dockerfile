...
LABEL distro_style="zypper" distro="opensuse" distro_long="opensuse-42.2" arch="x86_64" ocaml_version="4.03.0+flambda" opam_version="master" operatingsystem="linux"
