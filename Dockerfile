...
LABEL distro_style="zypper" distro="opensuse" distro_long="opensuse-42.1" arch="x86_64" ocaml_version="4.04.1+flambda" opam_version="master" operatingsystem="linux"
